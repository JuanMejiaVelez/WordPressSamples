...
namespace System.Windows.Controls
{
  ...
  [TemplatePart(Name = DatePickerEx.ElementRoot, Type = typeof(FrameworkElement))]
  [TemplatePart(Name = DatePickerEx.ElementTextBox, Type = typeof(DatePickerExTextBox))]
  [TemplatePart(Name = DatePickerEx.ElementButton, Type = typeof(Button))]
  [TemplatePart(Name = DatePickerEx.ElementPopup, Type = typeof(Popup))]
  ...
  [StyleTypedProperty(Property = "CalendarStyle", StyleTargetType = typeof(CalendarEx))]
  public partial class DatePickerEx : Control
  {
    /// <summary>
    ...
    /// Inherited code: Requires comment.
    /// </summary>
    private DatePickerExTextBox _textBox;
    ...
    /// </summary>
    public event EventHandler<DatePickerExDateValidationErrorEventArgs> DateValidationError;
    ...
    public DatePickerEx()
    {
      ...
      DefaultStyleKey = typeof(DatePickerEx);
    }
    ...
    /// <summary>
    /// Gets or sets the display mode to use for the calendar part.
    /// </summary>
    /// <value>
    /// The display mode used for the calendar.
    /// </value>
    public CalendarExMode CalendarMode
    {
      get { return (CalendarExMode)GetValue(CalendarModeProperty); }
      set { SetValue(CalendarModeProperty, value); }
    }

    /// <summary>
    /// Identifies the
    /// <see cref="P:System.Windows.Controls.DatePicker.CalendarMode" />
    /// dependency property.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// CalendarModeProperty property changed handler.
    /// </summary>
    /// <param name="d">DatePicker that changed its CalendarMode.</param>
    ...
    private static void OnCalendarModeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ...
      CalendarExMode cm = (CalendarExMode)e.NewValue;
    ...
    private static void OnIsDropDownOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ...
      if (dp._popUp != null && dp._popUp.Child != null)
      {
        ...
        {
          if (dp._calendar.DisplayMode != CalendarExMode.Month)
          {
            dp._calendar.DisplayMode = CalendarExMode.Month;
          }
    ...
    /// </exception>
    public DatePickerExFormat SelectedDateFormat
    {
      get { return (DatePickerExFormat)GetValue(SelectedDateFormatProperty); }
    ...
    public static readonly DependencyProperty SelectedDateFormatProperty =
        DependencyProperty.Register(
        "SelectedDateFormat",
        typeof(DatePickerExFormat),
        typeof(DatePickerEx),
        new PropertyMetadata(DatePickerExFormat.Short, OnSelectedDateFormatChanged));
    ...
    private static void OnSelectedDateFormatChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ...
      if (IsValidSelectedDateFormat((DatePickerExFormat)e.NewValue))
      {
        if (dp._textBox != null)
        {
    ...
    private static void OnTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
      ...
      if (!dp.IsHandlerSuspended(DatePickerEx.TextProperty))
      {
        ...
        else
        {
          if (!dp._settingSelectedDate)
          {
            dp.SetValueNoCallback(DatePickerEx.SelectedDateProperty, null);
          }
        }
      }
      else
    ...
    public override void OnApplyTemplate()
    {
      ...
      _textBox = GetTemplateChild(ElementTextBox) as DatePickerExTextBox;
    ...
    {
      return new DatePickerExAutomationPeer(this);
    }
    ...
    /// </param>
    protected virtual void OnDateValidationError(DatePickerExDateValidationErrorEventArgs e)
    {
      EventHandler<DatePickerExDateValidationErrorEventArgs> handler = this.DateValidationError;
      if (handler != null)
      {
        handler(this, e);
      }
    ...
    /// <param name="sender">Inherited code: Requires comment 1.</param>
    /// <param name="e">Inherited code: Requires comment 2.</param>
    private void Calendar_DisplayDateChanged(object sender, CalendarExDateChangedEventArgs e)
    {
    ...
    private void Calendar_KeyDown(object sender, KeyEventArgs e)
    {
      ...
      if (!e.Handled && (e.Key == Key.Enter || e.Key == Key.Space || e.Key == Key.Escape) && c.DisplayMode == CalendarExMode.Month)
      {
        this.Focus();
        this.IsDropDownOpen = false;
    ...
    protected override void OnMouseWheel(MouseWheelEventArgs e)
    {
      ...
      if (!e.Handled && this.SelectedDate.HasValue)
      {
        ...
        if (newDate.HasValue && CalendarEx.IsValidDateSelection(this._calendar, newDate.Value))
        {
    ...
    /// <summary>
    /// Handles the 
    /// <see cref="P:System.Windows.Controls.Calendar.Calendar.DisplayModeChanged"/>
    /// event.
    /// </summary>
    /// <param name="sender">Object who fires the event.</param>
    /// <param name="e">Parameters passed in the event.</param>
    private void Calendar_DisplayModeChanged(object sender, CalendarExModeChangedEventArgs e)
    {
      if (this.CalendarMode == CalendarExMode.Year)
      {
        if (_calendar.DisplayMode == CalendarExMode.Month)
        {
          _calendar.DisplayMode = CalendarExMode.Year;
    ...
    private string DateTimeToString(DateTime d)
    {
      ...
      {
        case DatePickerExFormat.Short:
          return string.Format(CultureInfo.CurrentCulture, d.ToString(dtfi.ShortDatePattern, dtfi));
        case DatePickerExFormat.Long:
          return string.Format(CultureInfo.CurrentCulture, d.ToString(dtfi.LongDatePattern, dtfi));
        #region Juan Mejia - Modification
        case DatePickerExFormat.MonthYear:
          return string.Format(CultureInfo.CurrentCulture, d.ToString(dtfi.YearMonthPattern, dtfi));
        #endregion
      }
      return null;
    }
    ...
    {
      DatePickerEx dp = sender as DatePickerEx;
      Debug.Assert(dp != null, "The DatePicker should not be null!");
    ...
    {
      _calendar = new CalendarEx();
      _calendar.DayButtonMouseUp += new MouseButtonEventHandler(Calendar_DayButtonMouseUp);
      _calendar.DisplayDateChanged += new EventHandler<CalendarExDateChangedEventArgs>(Calendar_DisplayDateChanged);
      ...
      _calendar.SelectionMode = CalendarExSelectionMode.SingleDate;
      ...
      _calendar.DisplayModeChanged += new EventHandler<CalendarExModeChangedEventArgs>(Calendar_DisplayModeChanged);
      #endregion
    }
    ...
    /// <returns>Inherited code: Requires comment 2.</returns>
    private static bool IsValidSelectedDateFormat(DatePickerExFormat value)
    {
      DatePickerExFormat format = (DatePickerExFormat)value;
      return format == DatePickerExFormat.Long
          || format == DatePickerExFormat.Short
      #region Juan Mejia - Modification
          || format == DatePickerExFormat.MonthYear;
      #endregion
    }
    ...
    private void OnDateSelected(DateTime? addedDate, DateTime? removedDate)
    {
      ...
      DatePickerExAutomationPeer peer = FrameworkElementAutomationPeer.FromElement(this) as DatePickerExAutomationPeer;
      if (peer != null)
      {
    ...
    private DateTime? ParseText(string text)
    {
      ...
      try
      {
        ...
        if (CalendarEx.IsValidDateSelection(this._calendar, newSelectedDate))
        {
          return newSelectedDate;
        }
        else
        {
          DatePickerExDateValidationErrorEventArgs dateValidationError = new DatePickerExDateValidationErrorEventArgs(new ArgumentOutOfRangeException("text", System.Windows.Controls.Properties.Resources.Calendar_OnSelectedDateChanged_InvalidValue), text);
      ...
      {
        DatePickerExDateValidationErrorEventArgs textParseError = new DatePickerExDateValidationErrorEventArgs(ex, text);
    ...
    private void SetWaterMarkText()
    {
      if (this._textBox != null)
      {
        ...
        switch (this.SelectedDateFormat)
        {
          ...
          case DatePickerExFormat.MonthYear:
            {
              this._textBox.Watermark = string.Format(CultureInfo.CurrentCulture, System.Windows.Controls.Properties.Resources.DatePicker_WatermarkText, dtfi.YearMonthPattern.ToString());
              break;
            }
          #endregion
        }
    ...
    private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
    {
      if (this._textBox != null)
      {
        this.SetValueNoCallback(DatePickerEx.TextProperty, this._textBox.Text);
      }
    }
