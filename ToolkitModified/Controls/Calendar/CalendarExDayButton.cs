...
namespace System.Windows.Controls.Primitives
{
    ...
    [TemplateVisualState(Name = CalendarExDayButton.StateRegularDay, GroupName = CalendarExDayButton.GroupDay)]
    [TemplateVisualState(Name = CalendarExDayButton.StateToday, GroupName = CalendarExDayButton.GroupDay)]
    [TemplateVisualState(Name = CalendarExDayButton.StateNormalDay, GroupName = CalendarExDayButton.GroupBlackout)]
    [TemplateVisualState(Name = CalendarExDayButton.StateBlackoutDay, GroupName = CalendarExDayButton.GroupBlackout)]
    public sealed class CalendarExDayButton : Button
    {
        ...
        /// class.
        /// </summary>
        public CalendarExDayButton()
            : base()
        {
            DefaultStyleKey = typeof(CalendarExDayButton);
            IsTabStop = false;
            Loaded += OnLoad;
        ...
        {
            return new CalendarExDayButtonAutomationPeer(this);
        }
