...
namespace System.Windows.Controls
{
    ...
    public sealed class CalendarExBlackoutDatesCollection : ObservableCollection<CalendarExDateRange>
    {
        /// <summary>
        ...
        {
            Add(new CalendarExDateRange(DateTime.MinValue, DateTime.Today.AddDays(-1)));
        }
        ...
        public bool Contains(DateTime start, DateTime end)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                CalendarExDateRange range = this[i];
        ...
        /// otherwise, false.
        /// </returns>
        public bool ContainsAny(CalendarExDateRange range)
        {
        ...
        /// This implementation raises the CollectionChanged event.
        /// </remarks>
        protected override void InsertItem(int index, CalendarExDateRange item)
        {
            EnsureValidThread();
        ...
        /// This implementation raises the CollectionChanged event.
        /// </remarks>
        protected override void SetItem(int index, CalendarExDateRange item)
        {
            EnsureValidThread();
        ...
        private bool IsValid(CalendarExDateRange item)
        {
