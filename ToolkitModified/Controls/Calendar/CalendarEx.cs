...
namespace System.Windows.Controls
{
    ...
    [TemplatePart(Name = CalendarEx.ElementRoot, Type = typeof(Panel))]
    [TemplatePart(Name = CalendarEx.ElementMonth, Type = typeof(CalendarExItem))]
    ...
    [StyleTypedProperty(Property = "CalendarButtonStyle", StyleTargetType = typeof(CalendarExButton))]
    [StyleTypedProperty(Property = "CalendarDayButtonStyle", StyleTargetType = typeof(CalendarExDayButton))]
    [StyleTypedProperty(Property = "CalendarItemStyle", StyleTargetType = typeof(CalendarExItem))]
    public partial class CalendarEx : Control
    {
        /// <summary>
        ...
        /// </summary>
        internal CalendarExItem MonthControl
        {
            get
            {
                if (Root != null && Root.Children.Count > 0)
                {
                    return Root.Children[0] as CalendarExItem;
                }
                return null;
            }
        }
        ...
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal CalendarExDayButton FocusButton { get; set; }

        /// <summary>
        /// Gets or sets Inherited code: Requires comment.
        /// </summary>
        internal CalendarExButton FocusCalendarButton { get; set; }

        #region CalendarButtonStyle
        /// <summary>
        /// Gets or sets the <see cref="T:System.Windows.Style" /> associated
        /// with the control's internal
        /// <see cref="T:System.Windows.Controls.Primitives.CalendarExButton" />
        /// object.
        /// </summary>
        /// <value>
        ...
        private static void OnCalendarButtonStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            CalendarEx c = d as CalendarEx;

            if (newStyle != null && c != null)
            {
                CalendarExItem monthControl = c.MonthControl;

                if (monthControl != null && monthControl.YearView != null)
                {
                    foreach (UIElement child in monthControl.YearView.Children)
                    {
                        CalendarExButton calendarButton = child as CalendarExButton;
        ...
        private static void EnsureCalendarButtonStyle(CalendarExButton calendarButton, Style oldCalendarButtonStyle, Style newCalendarButtonStyle)
        {
        ...
        /// Gets or sets the <see cref="T:System.Windows.Style" /> associated
        /// with the control's internal
        /// <see cref="T:System.Windows.Controls.Primitives.CalendarExDayButton" />
        /// object.
        /// </summary>
        /// <value>
        /// The current style of the
        ...
        private static void OnCalendarDayButtonStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newStyle != null && c != null)
            {
                ...
                if (monthControl != null && monthControl.MonthView != null)
                {
                    ...
                    {
                        CalendarExDayButton dayButton = child as CalendarExDayButton;
        ...
        private static void EnsureDayButtonStyle(CalendarExDayButton dayButton, Style oldDayButtonStyle, Style newDayButtonStyle)
        {
        ...
        /// Gets or sets the <see cref="T:System.Windows.Style" /> associated
        /// with the control's internal
        /// <see cref="T:System.Windows.Controls.Primitives.CalendarExItem" />
        /// object.
        /// </summary>
        /// <value>
        /// The current style of the
        ...
        private static void EnsureMonthStyle(CalendarExItem month, Style oldMonthStyle, Style newMonthStyle)
        {
        ...
        /// </value>
        public CalendarExMode DisplayMode
        {
            get { return (CalendarExMode) GetValue(DisplayModeProperty); }
        ...
        private static void OnDisplayModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            CalendarEx c = d as CalendarEx;
            Debug.Assert(c != null, "c should not be null!");
            CalendarExMode mode = (CalendarExMode) e.NewValue;
            CalendarExMode oldMode = (CalendarExMode) e.OldValue;
            CalendarExItem monthControl = c.MonthControl;

            if (!c.IsHandlerSuspended(CalendarEx.DisplayModeProperty))
            {
                if (IsValidDisplayMode(mode))
                {
                    ...
                    c.OnDisplayModeChanged(new CalendarExModeChangedEventArgs((CalendarExMode)e.OldValue, mode));
                }
                else
                {
                    c.SetValueNoCallback(CalendarEx.DisplayModeProperty, e.OldValue);
        ...
        private static bool IsValidDisplayMode(CalendarExMode mode)
        {
            return mode == CalendarExMode.Month
                || mode == CalendarExMode.Year
                || mode == CalendarExMode.Decade;
        }
        ...
        private void OnDisplayModeChanged(CalendarExModeChangedEventArgs args)
        {
            EventHandler<CalendarExModeChangedEventArgs> handler = DisplayModeChanged;
        ...
        /// </para>
        /// </remarks>
        public CalendarExSelectionMode SelectionMode
        {
            get { return (CalendarExSelectionMode) GetValue(SelectionModeProperty); }
        ...
        public static readonly DependencyProperty SelectionModeProperty =
            DependencyProperty.Register(
            "SelectionMode",
            typeof(CalendarExSelectionMode),
            typeof(CalendarEx),
        ...
        private static void OnSelectionModeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                c.SetValueNoCallback(CalendarEx.SelectedDateProperty, null);
        ...
        {
            CalendarExSelectionMode mode = (CalendarExSelectionMode) value;

            return mode == CalendarExSelectionMode.SingleDate
                || mode == CalendarExSelectionMode.SingleRange
                || mode == CalendarExSelectionMode.MultipleRange
                || mode == CalendarExSelectionMode.None;
        }
        ...
        private static void OnSelectedDateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(CalendarEx.SelectedDateProperty))
            {
                if (c.SelectionMode != CalendarExSelectionMode.None)
                {
                    DateTime? addedDate;
                    ...
                    if (IsValidDateSelection(c, addedDate))
                    {
                        ...
                        if (c.SelectionMode == CalendarExSelectionMode.SingleDate)
                        {
        ...
        ///                             exception.
        /// </remarks>
        public SelectedDatesExCollection SelectedDates { get; private set; }
        ...
        internal void OnSelectedDatesCollectionChanged(SelectionChangedEventArgs e)
        {
            if (IsSelectionChanged(e))
            {
                ...
                {
                    CalendarExAutomationPeer peer = FrameworkElementAutomationPeer.FromElement(this) as CalendarExAutomationPeer;
                    if (peer != null)
                    {
        ...
        internal DateTime? LastSelectedDate
        {
            ...
            set
            {
                ...
                if (SelectionMode == CalendarExSelectionMode.None)
                {
                    if (FocusButton != null)
                    {
        ...
        /// </para>
        /// </remarks>
        public CalendarExBlackoutDatesCollection BlackoutDates { get; private set; }
        ...
        {
            UpdateDisplayDate((CalendarEx)d, (DateTime)e.NewValue, (DateTime)e.OldValue);
        }
        ...
        private static void UpdateDisplayDate(CalendarEx c, DateTime addedDate, DateTime removedDate)
        {
            Debug.Assert(c != null, "c should not be null!");
            ...
            c.UpdateMonths();
            c.OnDisplayDate(new CalendarExDateChangedEventArgs(removedDate, addedDate));
        }
        ...
        /// </summary>
        /// <param name="e">Inherited code: Requires comment 1.</param>
        private void OnDisplayDate(CalendarExDateChangedEventArgs e)
        {
            EventHandler<CalendarExDateChangedEventArgs> handler = DisplayDateChanged;
            if (null != handler)
            {
                handler(this, e);
            }
        ...
        private static void OnDisplayDateStartChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(CalendarEx.DisplayDateStartProperty))
            {
        ...
        /// <returns>Inherited code: Requires comment 2.</returns>
        private static DateTime? SelectedDateMin(CalendarEx cal)
        {
        ...
        private static void OnDisplayDateEndChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!c.IsHandlerSuspended(CalendarEx.DisplayDateEndProperty))
            {
                DateTime? newValue = e.NewValue as DateTime?;
        ...
        /// <param name="cal">Inherited code: Requires comment 1.</param>
        /// <returns>Inherited code: Requires comment 2.</returns>
        private static DateTime? SelectedDateMax(CalendarEx cal)
        {
        ...
        /// </remarks>
        public event EventHandler<CalendarExDateChangedEventArgs> DisplayDateChanged;
        ...
        /// property is changed.
        /// </summary>
        public event EventHandler<CalendarExModeChangedEventArgs> DisplayModeChanged;
        ...
        public CalendarEx()
        {
            DefaultStyleKey = typeof(CalendarEx);
            ...
            BlackoutDates = new CalendarExBlackoutDatesCollection(this);
            SelectedDates = new SelectedDatesExCollection(this);
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (Root != null)
            {
                CalendarExItem month = GetTemplateChild(ElementMonth) as CalendarExItem;
        ...
        {
            Debug.Assert(sender is CalendarEx, "The sender should be a Calendar!");
        ...
        {
            CalendarExDayButton d;
            CalendarExItem monthControl = MonthControl;
            ...
            if (monthControl != null)
            {
                if (monthControl.MonthView != null)
                {
                    ...
                    {
                        d = monthControl.MonthView.Children[childIndex] as CalendarExDayButton;
        ...
        {
            return new CalendarExAutomationPeer(this);
        }
        ...
        /// <returns>Inherited code: Requires comment 2.</returns>
        internal CalendarExDayButton FindDayButtonFromDay(DateTime day)
        {
            CalendarExDayButton b;
            DateTime? d;
            CalendarExItem monthControl = MonthControl;
            ...
            if (monthControl != null)
            {
                if (monthControl.MonthView != null)
                {
                    for (int childIndex = ColumnsPerMonth; childIndex < count; childIndex++)
                    {
                        b = monthControl.MonthView.Children[childIndex] as CalendarExDayButton;
        ...
        private void OnSelectedMonthChanged(DateTime? selectedMonth)
        {
            ...
            {
                Debug.Assert(DisplayMode == CalendarExMode.Year, "DisplayMode should be Year!");
        ...
        private void OnSelectedYearChanged(DateTime? selectedYear)
        {
            ...
            {
                Debug.Assert(DisplayMode == CalendarExMode.Decade, "DisplayMode should be Decade!");
        ...
        internal static bool IsValidDateSelection(CalendarEx cal, object value)
        {
            if (value == null)
            {
                return true;
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        cal.SetValueNoCallback(CalendarEx.DisplayDateStartProperty, value);
                    }
                    else if (DateTime.Compare((DateTime) value, cal.DisplayDateRangeEnd) > 0)
                    {
                        cal.SetValueNoCallback(CalendarEx.DisplayDateEndProperty, value);
                    }
                    return true;
                }
            }
        ...
        /// <param name="value">Inherited code: Requires comment 2.</param>
        /// <returns>Inherited code: Requires comment 3.</returns>
        private static bool IsValidKeyboardSelection(CalendarEx cal, object value)
        {
            if (value == null)
            {
                return true;
        ...
        {
            if (SelectionMode == CalendarExSelectionMode.None && lastSelectedDate != null)
            {
            ...
            {
                if (SelectionMode == CalendarExSelectionMode.SingleRange || SelectionMode == CalendarExSelectionMode.MultipleRange)
                {
                    foreach (DateTime item in SelectedDates)
                    {
                        RemovedItems.Add(item);
                    ...
                    if (shift)
                    {
                        ...
                        // update the HoverEnd
                        CalendarExDateRange range;

                        if (DateTime.Compare(HoverStart.Value, lastSelectedDate.Value) < 0)
                        {
                            range = new CalendarExDateRange(HoverStart.Value, lastSelectedDate.Value);
                        }
                        else
                        {
                            range = new CalendarExDateRange(lastSelectedDate.Value, HoverStart.Value);
                        }
        ...
        internal void HighlightDays()
        {
            if (HoverEnd != null && HoverStart != null)
            {
                ...
                if (HoverEndIndex != null && HoverStartIndex != null)
                {
                    ...
                    {
                        b = monthControl.MonthView.Children[i] as CalendarExDayButton;
                        b.IsSelected = true;
                        d = b.DataContext as DateTime?;
        ...
        internal void UnHighlightDays()
        {
            if (HoverEnd != null && HoverStart != null)
            {
                ...
                if (HoverEndIndex != null && HoverStartIndex != null)
                {
                    ...
                    if (SelectionMode == CalendarExSelectionMode.MultipleRange)
                    {
                        for (i = startIndex; i <= endIndex; i++)
                        {
                            b = monthControl.MonthView.Children[i] as CalendarExDayButton;
                    ...
                    else
                    {
                        ...
                        for (i = startIndex; i <= endIndex; i++)
                        {
                            (monthControl.MonthView.Children[i] as CalendarExDayButton).IsSelected = false;
                        }
                    }
                }
            }
        ...
        {
            Debug.Assert(DisplayMode == CalendarExMode.Year || DisplayMode == CalendarExMode.Decade, "The DisplayMode should be Year or Decade");
            CalendarExItem monthControl = MonthControl;
        ...
        {
            if (DisplayMode == CalendarExMode.Month && DisplayDate != null)
            {
            ...
            {
                if (DisplayMode == CalendarExMode.Year)
                {
        ...
        {
            Debug.Assert(DisplayMode == CalendarExMode.Month, "DisplayMode should be Month!");
        ...
        {
            CalendarEx c = sender as CalendarEx;
            Debug.Assert(c != null, "c should not be null!");
        ...
        {
            if (DisplayMode == CalendarExMode.Month)
            {
                ...
                case CalendarExMode.Month:
                    {
                        if (ctrl)
                        {
                            ...
                            DisplayMode = CalendarExMode.Year;
                        }
                        else
                        {
                ...
                case CalendarExMode.Year:
                    {
                        if (ctrl)
                        {
                            ...
                            DisplayMode = CalendarExMode.Decade;
                        }
                        else
                        {
                ...
                case CalendarExMode.Year:
                    {
                        if (ctrl)
                        {
                            ...
                            DisplayMode = CalendarExMode.Month;
                        }
                        else
                        {
                            DateTime? selectedMonth = DateTimeHelper.AddMonths(_selectedMonth, ColumnsPerYear);
        ...
        {
            if (_isShiftPressed && (SelectionMode == CalendarExSelectionMode.SingleRange || SelectionMode == CalendarExSelectionMode.MultipleRange))
            {
                AddSelection();
