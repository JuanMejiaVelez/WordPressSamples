...
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IGridProvider.ColumnCount", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IGridProvider.GetItem(System.Int32,System.Int32)", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IGridProvider.RowCount", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IMultipleViewProvider.CurrentView", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IMultipleViewProvider.GetSupportedViews()", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IMultipleViewProvider.GetViewName(System.Int32)", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.IMultipleViewProvider.SetCurrentView(System.Int32)", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ISelectionProvider.CanSelectMultiple", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ISelectionProvider.GetSelection()", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ISelectionProvider.IsSelectionRequired", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ITableProvider.GetColumnHeaders()", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ITableProvider.GetRowHeaders()", Justification = "WPF Compatibility")]
[assembly: SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Scope = "member", Target = "System.Windows.Automation.Peers.CalendarExAutomationPeer.#System.Windows.Automation.Provider.ITableProvider.RowOrColumnMajor", Justification = "WPF Compatibility")]
...
namespace System.Windows.Automation.Peers
{
    ...
    public partial class CalendarExAutomationPeer :
        ...
        ITableProvider
    {
        ...
        /// </summary>
        private CalendarEx OwningCalendar
        {
            get { return Owner as CalendarEx; }
        }
        ...
        private Grid OwningGrid
        {
            get
            {
                ...
                {
                    if (calendar.DisplayMode == CalendarExMode.Month)
                    {
        ...
        int IGridProvider.RowCount
        {
            get
            {
                ...
                if (owner != null)
                {
                    if (OwningCalendar.DisplayMode == CalendarExMode.Month)
                    {
        ...
        bool ISelectionProvider.CanSelectMultiple
        {
            get
            {
                CalendarEx owner = OwningCalendar;
                return owner.SelectionMode == CalendarExSelectionMode.SingleRange ||
                     owner.SelectionMode == CalendarExSelectionMode.MultipleRange;
            }
        }
        ...
        int[] IMultipleViewProvider.GetSupportedViews()
        {
            ...
            supportedViews[0] = (int) CalendarExMode.Month;
            supportedViews[1] = (int) CalendarExMode.Year;
            supportedViews[2] = (int) CalendarExMode.Decade;
        ...
        {
            OwningCalendar.DisplayMode = (CalendarExMode) viewId;
        }
        ...
        IRawElementProviderSimple[] ISelectionProvider.GetSelection()
        {
            ...
            if (OwningGrid != null)
            {
                if (OwningCalendar.DisplayMode == CalendarExMode.Month && OwningCalendar.SelectedDates != null && OwningCalendar.SelectedDates.Count != 0)
                {
                    // return selected DayButtons
                    CalendarExDayButton dayButton;
                    ...
                    foreach (UIElement child in OwningGrid.Children)
                    {
                        ...
                        if (childRow != 0)
                        {
                            dayButton = child as CalendarExDayButton;
                ...
                else
                {
                    ...
                    CalendarExButton calendarButton;

                    foreach (UIElement child in OwningGrid.Children)
                    {
                        calendarButton = child as CalendarExButton;
