...
namespace System.Windows.Controls.Primitives
{
    ...
    public sealed class CalendarExButton : Button
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public CalendarExButton()
            : base()
        {
            DefaultStyleKey = typeof(CalendarExButton);
            IsTabStop = false;
            Loaded += OnLoad;
        ...
        {
            return new CalendarExButtonAutomationPeer(this);
        }
